namespace _08.Military_Elite.Controllers
{
    ...
    public class SoldiersManager
    {
        ...
        internal string RegisterEngineer(string id, string firstName, string lastName, double salary, string corps,
            string[] repairsData)
        {
        ...
        internal string RegisterCommando(string id, string firstName, string lastName, double salary, string corps,
            string[] missionsData)
        {
